    ...
    @swagger_auto_schema(
        manual_parameters=[
            ...
            openapi.Parameter(
                ...
                'data de início do período de tempo ao qual as anotações devem ser modificadas',
                type=openapi.TYPE_STRING),
            openapi.Parameter(
                'data_fim', openapi.IN_PATH,
                'data de fim do período de tempo ao qual as anotações devem ser modificadas',
                type=openapi.TYPE_STRING),
            openapi.Parameter(
                'peso', openapi.IN_PATH, 'Se deve retornar apenas as anotações tão ou mais importantes do que este valor', type=openapi.TYPE_INTEGER),
            openapi.Parameter(
