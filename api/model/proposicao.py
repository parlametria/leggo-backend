...
class Proposicao(models.Model):
    ...
    sigla_camara = models.TextField('Sigla da proposição na Câmara', null=True, blank=True)

    sigla_senado = models.TextField('Sigla da proposição no Senado', null=True, blank=True)
