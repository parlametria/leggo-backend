...
urlpatterns = [
    ...
    url(r"^proposicoes/(?P<id>[0-9]+)/?$", ProposicaoDetail.as_view()),
    ...
    url(r"^pressao/(?P<id_leggo>[0-9]+)/?$", PressaoList.as_view()),
    url(r"^coautorias_node/(?P<id>[0-9]+)/?$", CoautoriaNodeList.as_view()),
    url(r"^coautorias_edge/(?P<id>[0-9]+)/?$", CoautoriaEdgeList.as_view()),
    url(r"^autorias/(?P<id>[0-9]+)/?$", AutoriaList.as_view()),
    ...
    url(r"^temas/(?P<interesse>[a-z]+)?$", TemaList.as_view()),
